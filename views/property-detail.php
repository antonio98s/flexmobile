...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="/realestate/views/index.php">Casa</a> / Vendita</span>
    <h2>Vendita</h2>
</div>
</div>
<!-- banner -->
...
<!-- #Slider Ends -->
  ...
  <div class="spacer"><h4><span class="glyphicon glyphicon-th-list"></span> Descrizione</h4>
...
<p class="price">€ <?php echo $singleData->monthly_charges ?></p>
  <p class="area"><span class="glyphicon glyphicon-map-marker"></span>Indirizzo :  <?php echo $singleData->address ?></p>
  <p class="area"><span class="glyphicon glyphicon-th-list"></span>Metri quadri :  <?php echo $singleData->floor_space ?> mq</p>
  <p class="area"><span class="glyphicon glyphicon-th-list"></span>Ascensore :  <?php echo $singleData->access ?></p>
  <p class="area"><span class="glyphicon glyphicon-th-list"></span>Utenza :  <?php echo $singleData->utility ?></p>
</div>
